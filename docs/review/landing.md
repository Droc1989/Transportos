...
- Comision: 0%; pilot: 10 firme, maximum 10 vehicule per firmă. Pachetele complete sunt afișate numai în /inregistrare-firma.
...
/inregistrare-firma, cu pachetele deasupra formularului: ecran nou față de referințele din docs/design, necesită aprobarea proprietarului. Folosește componentele și tokenurile existente. Prezentarea pachetelor nu implementează facturarea abonamentelor sau schimbarea planului.
